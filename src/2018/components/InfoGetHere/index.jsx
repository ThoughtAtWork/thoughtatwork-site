...
class InfoGetHere extends React.Component {
  render() {
    return (
      <div className={classnames('gridish-container--complete gridish-container gridish-grid', styles.overflowYHidden)}>
        ...
        <Map
          ...
          mapElement={<div className={classnames(styles.map, 'content-Block--margin-top')} />}
        />
