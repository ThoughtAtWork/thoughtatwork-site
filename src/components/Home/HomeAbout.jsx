  ...
  render() {
    return (
      <div className={classnames('gridish-container--complete container gridish-grid content-Block--margin-top')}>
        ...
        <h3 className={classnames('gridish-grid__col--medium--5 gridish-grid__col--small--4 gridish-grid__col--xsmall--3')}>we provide a myriad of talks, design workshops, nightly events and more.</h3>
      </div>
    );
  }
}
