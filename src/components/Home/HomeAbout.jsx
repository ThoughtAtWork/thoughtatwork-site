  ...
  render() {
    return (
      <div className={classnames('gridish-container--complete container gridish-grid content-Block--margin-top')}>
        ...
        <h3 className={classnames('gridish-grid__col--medium--5 gridish-grid__col--small--4 gridish-grid__col--xsmall--3 text-transform--unset')}>We provide a variety of talks, design workshops, after parties and more. Held at RIT in Rochester, NY.</h3>
      </div>
    );
  }
}
