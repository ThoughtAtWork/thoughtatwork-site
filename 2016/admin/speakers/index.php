...
<body>
    ...
    <p>Separate keywords with a space, no commas. <code>ESC</code> to clear. Sorting columns: <img src="img/az.png" width="12" height="11" alt="a-z"/> Sort A-Z. <img src="img/za.png" width="12" height="11" alt="z-a" /> Sort Z-A.</p>
    ...
    ?>
            ...
            <form>
                <img src="img/first.png" title="First page" class="first"/>
                <img src="img/prev.png" title="Next page" class="prev"/>
                <input type="text" class="pagedisplay"/>
                <img src="img/next.png" title="Next page" class="next"/>
                <img src="img/last.png" title="Last page" class="last"/>
