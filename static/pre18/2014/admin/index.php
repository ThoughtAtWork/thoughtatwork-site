...
{
	global $mysqli;
	$query = "SELECT `trans_num`, `timestamp`, `refID`, `first`, `last`, `address`, `city`, `state`, `zipcode`, `email`, `phone`, `university`, `interpreterNeeded`, `amount` FROM `registrations` WHERE `refID` != ''";
...
<?
		...
		fwrite($fh, "Transaction Number, Timestamp, Reference ID, First Name, Last Name, Address, City, State, Zipcode, Email, Phone, University, Interpreter Requested, Amount\n");
